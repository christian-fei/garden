...
exports.gatherReport = (chat) => {
  ...
  return got(`https://api.openweathermap.org/data/2.5/weather?${query}`, { json: true })
    .then(({ body: { weatherData: {weather: [{description}],main: { temp: temperature, temp_min: minTemperature, temp_max: maxTemperature},dt: time,sys: { sunrise, sunset, temp: temperature }} } }) => {
